...
function openLink(e) {
    ...
    } else if (idName === currentPathName) { // current page
        // do nothing
    } else { // category page
...
export default function decorate(block) {
    const blogBreadCrumb = block.parentNode;
    block.textContent = '';
    const breadCrumbDiv = document.createElement('nav');
    breadCrumbDiv.classList.add('breadCrumb');
    breadCrumbDiv.setAttribute('id', 'breadCrumb-id');
    blogBreadCrumb.append(breadCrumbDiv);
    breadCrumbCreation(breadCrumbDiv.getAttribute('id'), 'Merative Blog', true); // pass true to create first time ul element 
    breadCrumbCreation(breadCrumbDiv.getAttribute('id'), getMetadata('category'), false); // pass false to use created ul element from previous function call.
    breadCrumbCreation(breadCrumbDiv.getAttribute('id'), currentPathName, false); // pass false to use created ul element from previous function call.
}